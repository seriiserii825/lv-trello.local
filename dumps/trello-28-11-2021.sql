...
INSERT INTO `projects` VALUES (1,'Segalerba','segalerba','2021-11-26 16:12:05','2021-11-27 07:06:21','rgba(255, 141, 0, 0.52)'),(2,'Moonflower','moonflower','2021-11-26 16:12:15','2021-11-27 07:05:48','rgba(124.00000000000009, 160.99999999999997, 38.99999999999999, 0.54)'),(3,'Remax','remax','2021-11-26 16:12:24','2021-11-27 07:01:03','rgba(23.000000000000053, 43.00000000000015, 168.00000000000003, 0.31)'),(4,'Fratellibandini','fratellibandini','2021-11-26 16:16:11','2021-11-27 07:02:07','rgba(255, 187.99999999999983, 0, 0.54)'),(5,'Bludelego','bludelego','2021-11-27 07:11:46','2021-11-27 07:12:09','rgba(28.99999999999998, 113.00000000000006, 182, 0.37)');
...
CREATE TABLE `user_project` (
  ...
  CONSTRAINT `user_project_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`),
  CONSTRAINT `user_project_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-11-28 21:39:59
